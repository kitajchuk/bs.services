...
const router = {
  ...
  init() {
    ...
    this.routerEx = core.dom.navi.find(".js-router-ex");
    this.bindEmpty();
    this.initPages();
  ...
  changeClass(data) {
    ...
    if (this.uid && data.request.params.view === "info") {
      this.routerEx[0].href = `/${this.view}/${this.uid}/`;
    } else {
      this.routerEx[0].href = "/";
    }
